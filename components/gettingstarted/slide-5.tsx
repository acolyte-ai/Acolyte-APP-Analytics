...
export default function CollegeSelectionSlide({ selectedCollege, setSelectedCollege }) {
    ...
    return (
        <div className="flex justify-center flex-col w-full items-center">
            ...
            {/* Subtitle */}
            <p className="text-gray-500 text-center mt-2 max-w-lg mb-3 max-sm:text-sm">
            ...
            <div className="mt-12 w-full max-w-[400px] relative">
                    ...
                    {selectedCollege ? (
                        ...
                        <div className="">
                            <Input
                                ...
                                className="pl-14 pr-14 py-3 border border-gray-300
                                rounded-lg text-sm shadow-sm focus:border-purple-300
                ...
                {showDropdown && !selectedCollege && (
                    <div
                        ref={dropdownRef}
                        className="absolute z-50 w-full bg-white border text-sm text-gray-500 border-gray-200 rounded-md shadow-lg max-h-96 overflow-auto p-2"
                        style={{
                            bottom: '100%',  // Position at the bottom of the parent element
                            marginBottom: '8px',  // Add space between dropdown and input
                        ...
                        {searchTerm.trim() === '' ? (
                            <>
                                {colleges.map((college, index) => (
                                    <div
                                        key={index}
                                        className="px-4 py-3 hover:bg-purple-50 cursor-pointer truncate"
