...
export default function ExamPreparationSlide({ customExam, setCustomExam, selectedExam, setSelectedExam }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-6  w-full max-w-md mx-auto">
            {/* Heading */}
            <h1 className="text-2xl font-semibold text-purple-800 text-center max-sm:text-lg">
                    ...
                    <MultiSelectorTrigger className="w-full p-3 max-sm:py-1 border bg-white dark:bg-white border-purple-200 rounded-lg shadow-sm">
                        <div className="flex items-center w-full justify-between">
                            <div className="flex items-center relative w-full">
                                ...
                                <MultiSelectorInput placeholder="Select an exam..." className=" w-full z-10 max-sm:text-sm" />
