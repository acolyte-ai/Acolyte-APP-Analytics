...
export default function MedicalSubjectsSlide({ selectedSubject, setSelectedSubject }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-6 bg-white dark:bg-white w-full max-w-md mx-auto">
            {/* Heading */}
            <h1 className="text-2xl max-sm:text-lg font-semibold text-purple-800 text-center">
                Which Subject challenges you the most?
            </h1>

            {/* Subtitle */}
            <p className="text-gray-500 text-center mt-2 mb-6 max-sm:text-sm">
                Select the medical subject you find most difficult
            </p>

            {/* MultiSelector for subject selection */}
            <div className="w-full mb-6 bg-white dark:bg-white">
                <MultiSelector
                ...
                >
                    <MultiSelectorTrigger className="w-full p-3 max-sm:py-1 border bg-white dark:bg-white border-purple-200 rounded-lg shadow-sm">
                        <div className="flex items-center w-full justify-between">
                            <div className="flex items-center w-full relative">
                                <Search className="h-4 w-4 text-gray-400 mr-2" />
                                <MultiSelectorInput placeholder="Select a subject..." className=" w-full z-10 max-sm:text-sm" />
