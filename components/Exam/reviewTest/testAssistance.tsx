...
import ExaminationInstructions from "../dailytest/help-test";
  ...
  return (
    ...
    >
      ...
      <div className="text-green-400 font-medium max-sm:col-span-1 gap-2 items-center flex 2xl:text-[18px] col-span-5 text-[15px]">
        ...
        />
        <p>Time Left -</p>
        <p className="dark:text-emerald-400 text-[#228367] ">{formatTime(0)}</p>
      </div>
      ...
      <div className="grid grid-cols-4 max-sm:grid-cols-2 max-sm:col-span-1 2xl:gap-[18px] gap-4 col-span-7 font-medium font-pt-sans ">
        <Dialog>
          ...
          <DialogContent className="p-0 shadow-none  flex items-center justify-center border-none bg-transparent dark:bg-transparent" >
            <DialogHeader>
