...
import pdfUpload from "@/public/foldersIcon/folderInactive.svg";
...
const FileUpload = () => {
  ...
  const { setViewCombination } = useSettings()
        ...
        {activeTab === "upload" && (
          <div className="w-full ">
            ...
            <label
              ...
              onDrop={handleDrop}
              className={`w-full h-full   flex flex-col items-center justify-center cursor-pointer transition-colors ${isDragging
                ? "border-emerald-500 bg-emerald-50"
                : "border-gray-300"
                }`}
            >
              <div className="flex flex-col items-center justify-center gap-4">
                <Image src={pdfUpload} alt="pdficon" width={50} height={50} />
                <span className="text-emerald-500 tracking-wider text-center underline-offset-2 underline font-semibold ">
                  No Files Added
