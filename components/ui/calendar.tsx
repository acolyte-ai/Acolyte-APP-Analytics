  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-causten-semibold",
        ...
        head_row: "flex",
        head_cell:
          "text-neutral-500 rounded-md w-8 font-causten-semibold text-[0.8rem] dark:text-neutral-400",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-causten-semibold aria-selected:opacity-100"
        ),
