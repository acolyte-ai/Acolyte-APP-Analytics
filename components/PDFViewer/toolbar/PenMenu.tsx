...
const PenMenu = ({ selectedTool, onToolUpdate }) => {
  ...
  return (
    <div className="bg-white rounded-full py-1.5 px-10 flex items-center gap-4 w-full relative">
      {/* Stroke Width */}
      <div className="flex items-center gap-1.5">
        ...
        <div className="bg-gray-100 rounded px-1.5 py-0.5 flex items-center gap-0.5">
          <StrokeWidthIcon />
          <span className="text-gray-700 text-xs font-medium">{normalizedStrokeWidth}%</span>
        </div>
        <div className="w-20">
          <Slider
            value={[strokeWidth]}
      ...
      <div className="flex items-center gap-2 flex-1 w-44">
        ...
        <div className="bg-gray-100 rounded px-1.5 py-0.5 flex items-center gap-0.5">
          <span className="text-gray-700 text-xs font-medium">{normalizedOpacity}%</span>
        </div>
