...
export default function NoteDashboard() {
  ...
  return (
    <div className="w-full h-auto overscroll-y-none flex items-start px-4 md:px-6 lg:px-8 justify-start max-md:mb-20 overflow-x-hidden no-scrollbar">
      {/* Main Grid Container */}
        ...
        <div className="col-span-1 lg:col-span-2">
         ...
         dark:bg-[#181A1D] bg-[#F3F4F9] h-11 mb-[14px] dark:border-none border border-[#B8B8B8] shadow-md"
                >
                  <TabsTrigger
                    value="upload"
                    className="font-causten-semibold text-base w-full text-[16px]  dark:text-white tracking-normal
          dark:data-[state=active]:text-black data-[state=active]:text-white text-[#184C3D]  dark:data-[state=active]:bg-[#36AF8D]
             data-[state=active]:border-[#36AF8D] data-[state=active]:font-causten-semibold data-[state=active]:bg-[#36AF8D] data-[state=active]:shadow-none
          "
                  >
                    Create New
                  </TabsTrigger>
                  <TabsTrigger
                    value="recent"
                    className="text-[16px] font-causten-semibold text-base w-full dark:text-white tracking-normal
           dark:data-[state=active]:text-black data-[state=active]:text-white text-[#184C3D] dark:data-[state=active]:bg-[#36AF8D]
             data-[state=active]:border-[#36AF8D] data-[state=active]:font-causten-semibold data-[state=active]:bg-[#36AF8D] data-[state=active]:shadow-none
          "
                  >
                ...
                <TabsContent
                  value="recent"
                  className="w-full px-5 py-[21px] h-full overflow-y-auto no-scrollbar bg-[#F3F4F9] dark:bg-[#181A1D] rounded-[7px] shadow-[inset_0_0_8px_#B8B8B82B]"
                  style={{
                    scrollbarWidth: 'none',
          ...
          <Tabs defaultValue="upload" className="w-full  shadow-none ">
            <TabsList className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 lg:gap-y-5 w-full bg-transparent dark:bg-transparent h-auto mb-[14px]">
              <div className="w-full lg:w-auto min-w-0">
                <CardTitle className="text-lg sm:text-xl lg:text-[22px] font-causten-semibold tracking-wider text-[#228367] dark:text-white overflow-hidden truncate">
